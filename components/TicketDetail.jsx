      ...
      <div className="border-b border-slate-200 p-6 bg-white">
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex gap-2">
            <button className="px-4 py-2 bg-slate-100 text-slate-900 rounded-lg font-medium text-sm hover:bg-slate-200 transition">
              Assign
            </button>
        ...
        <div className="flex items-center gap-3 mt-4 flex-wrap">
          <span className={`text-xs font-medium px-3 py-1 rounded-full ${getStatusBg(ticket.status)}`}>
